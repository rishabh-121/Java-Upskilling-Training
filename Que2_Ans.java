...
public class Que2_Ans {
	public static void main(String args[]) {

		Labour t = new Labour();
		Manager m = new Manager();
		System.out.println("Total Salary Of Employees In Organisation is "
				+ (m.salary + (((m.incentive) + t.overtime)) + t.salary)); // displays total salary of emp in org//
